...
public class PlayerData : Singleton<PlayerData>
{
    ...
    void GetStoredData()
    {
        ...
        { // 원래는 기존 유저의 재설치인 경우도 생각해야하지만, 서버가 없는 시점에서는 항상 신규유저로 생각.
            ...
            Bag.Add(105, new List<ItemInstance>() { new ItemInstance(105), new ItemInstance(105) });
            Bag.Add(106, new List<ItemInstance>() { new ItemInstance(106), new ItemInstance(106), new ItemInstance(106) });
            Bag.Add(203, new List<ItemInstance>() { new ItemInstance(203), new ItemInstance(203) });
            Bag.Add(206, new List<ItemInstance>() { new ItemInstance(206) });
            Bag.Add(304, new List<ItemInstance>() { new ItemInstance(304) });
            Bag.Add(306, new List<ItemInstance>() { new ItemInstance(306) });
            Bag.Add(404, new List<ItemInstance>() { new ItemInstance(404) });
            Bag.Add(405, new List<ItemInstance>() { new ItemInstance(405) });
            Bag.Add(406, new List<ItemInstance>() { new ItemInstance(406) });
