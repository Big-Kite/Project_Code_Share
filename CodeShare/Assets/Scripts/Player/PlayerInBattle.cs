...
public class PlayerInBattle : BattleUnit
{
    ...
    public override void Init(int _dataKey = 0)
    {
        ...
        AtkDist = 2.0f;
        HpComponent.Init(PlayerData.Instance.Hp, PlayerData.Instance.Mp, 1.2f);
    }
    public override void TakeDamage(int _damage)
    {
        ...
        SoundManager.Instance.PlaySfx(SFX.Atk_Npc1);
    ...
    public override void CompleteAttack()
    {
        ...
        Target.TakeDamage(1);
        SoundManager.Instance.PlaySfx(SFX.Atk_Sword);
