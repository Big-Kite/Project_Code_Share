...
public class BattleManager : Singleton<BattleManager>
{
    ...
    IEnumerator Start()
    {
        ...
        ScreenHPSystem.Instance.Init(player);
        ...
        SoundManager.Instance.PlayBgm(BGM.BGM_Battle);
    }
    void Update()
    {
        if (!battleStart)
    ...
    public void CheckWinLose()
    {
        ...
        {
            // 플레이어 패배
            StageManager.Instance.BattleLose();
    ...
    IEnumerator CoBattleEnd(bool _win)
    {
        ...
        SoundManager.Instance.PlaySfx(_win ? SFX.Victory : SFX.Defeat);
        PopupManager.Instance.CloseLoading();
    }
